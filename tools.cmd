...
echo:
echo:                 Cac giai phap kich hoat ban quyen:
echo:
echo:             [1] Ko chay duoc        ^|  Windows          ^|   Permanent
echo:             [2] Ko chay duoc        ^|  Office           ^|   Permanent
echo:             [3] Key kich hoat 2038  ^|  Windows          ^|   Year 2038
echo:             [4] Kich hoat tron bo   ^|  Windows / Office ^|    180 Days
echo:             __________________________________________________      
echo:
echo:             [5] Tinh trang ban quyen Office va Windows
echo:             [6] Sua loi
echo:             [7] Tai office ban moi nhat
echo:             [8] Lien he - Dinh Quoc Khanh - Zalo: 0326888369
echo:             [0] Facebook: Dinh Khanh An
echo:       ______________________________________________________________
echo:
...
echo:       ______________________________________________________________
echo:
echo:             [1] Thay doi phien ban Windows
echo:
...
echo:
echo                 [3] Tai Office ban moi nhat
echo:
echo                 [0] %_exitmsg%
echo         ____________________________________________________________
echo: 
...
echo.              [2] Kich hoat - Office
echo.              [3] Kich hoat - Tat ca
echo.
...
if not defined _tskinstalled if not defined _oldtsk echo.              [4] Tu dong kich hoat lai ban quyen sau khi het han
echo.              [5] Uninstall
...
echo.       ______________________________________________________________
echo.
call :_color2 %_White% "           " %_Green% "Chon cac tuy chon bang ban phim [1,2,3,4,5,6,7,0]"
choice /C:12345670 /N
set _el=%errorlevel%
